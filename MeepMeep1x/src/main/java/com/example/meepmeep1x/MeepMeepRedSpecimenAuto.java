...
public class MeepMeepRedSpecimenAuto {
    ...
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(8, -62, Math.toRadians(270)))
                ...
                .splineToLinearHeading(new Pose2d(46, -58, Math.toRadians(90)), Math.toRadians(270))
                .lineToY(-62)

                .splineToConstantHeading(new Vector2d(46, -61), Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(4, -32, Math.toRadians(270)), Math.toRadians(90))
